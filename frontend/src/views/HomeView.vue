            ...
            <div class="job-listings">
                <div v-for="job in currentPageJobs" :key="job.item.id" class="job-card">
                    ...
                    <div class="job-meta">
                        ...
                        <span v-if="job.item.sponsorship === 'Offers Sponsorship'" class="sponsorship-tag">
                            Sponsorship
                        </span>
...
<script lang="ts" setup>
    ...
    watch([selectedCategories, sponsorshipFilter, selectedFAANG, searchQuery], () => {
    ...
    const toggleSponsorship = () => {
        ...
        sponsorshipFilter.value = sponsorshipFilter.value === SponsorshipFilter.ALL
            ? SponsorshipFilter.OFFERS
