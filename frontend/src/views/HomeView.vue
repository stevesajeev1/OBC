...
<style scoped>
    ...
    .search-bar {
        ...
        outline: none;
        transition: border-color 0.3s ease, background 0.3s ease; /* Add background transition */
        ...
        .search-bar:focus,
        .search-bar:hover { /* Add hover state */
            border-color: #d4862d;
    ...
    .job-card {
        ...
        .job-card::before {
            ...
            position: absolute;
            inset: 0;
            background: linear-gradient(180deg, rgba(163, 102, 38, 0.50) 0%, rgba(61, 14, 14, 0.50) 100%);
            opacity: 0;
